        ...
        for generation in range(num_generations):
            ...
            if next_population:
                ...
                for solution in next_population:
                    tuple_solution = tuple(solution)  # Convert list to tuple
                    if tuple_solution not in fitness_scores_dict:
                        total_predicted_rating, predicted_rating_list = self.calculate_total_rating(tuple_solution)
                        fitness_scores_dict[tuple_solution] = {
                            "total_predicted_rating": total_predicted_rating,
                            "predicted_rating_list": predicted_rating_list
                        }
                    if tuple_solution not in semratings_dict:
                        semrating = self.calculate_semrating(tuple_solution)
                        semratings_dict[tuple_solution] = semrating
            else:
